...
sim = rea_wit_fin_mat.T.corr()
print(sim)
print("calculating Pearson correlation coefficient...")
similarity = reaction_matrix.T.corr()
cos_similarity = pd.DataFrame(cosine_similarity(reaction_matrix))
...
predict_connection_prob, actual = random_sample_predict(reactions_all, reaction_matrix, reactant_list, product_list, sim, 2, 2)
